...
static HINTS: [(&str, HintImpl); 125] = [
    ...
    (SKIP_TX, skip_tx),
    (SKIP_CALL, skip_call),
    (unimplemented::CACHE_CONTRACT_STORAGE, unimplemented::unimplemented),
    (unimplemented::FETCH_STATE_ENTRY, unimplemented::unimplemented),
    (unimplemented::SET_INITIAL_STATE_UPDATES_PTR, unimplemented::unimplemented),
    (unimplemented::ENTER_SCOPE_NEW_NODE, unimplemented::unimplemented),
    (unimplemented::SET_AP_TO_CALLDATA_LEN, unimplemented::unimplemented),
    (unimplemented::ADD_RELOCATION_RULE, unimplemented::unimplemented),
    (unimplemented::SET_AP_TO_NONCE, unimplemented::unimplemented),
    (unimplemented::DECODE_NODE, unimplemented::unimplemented),
    (unimplemented::GEN_SIGNATURE_ARG, unimplemented::unimplemented),
    (unimplemented::GEN_CALLDATA_ARG, unimplemented::unimplemented),
    (unimplemented::SET_AP_TO_ENTRY_POINT_SELECTOR, unimplemented::unimplemented),
    (unimplemented::SET_TREE_STRUCTURE, unimplemented::unimplemented),
    (unimplemented::SPLIT_OUTPUT1, unimplemented::unimplemented),
    (unimplemented::WRITE_SYSCALL_RESULT, unimplemented::unimplemented),
    (unimplemented::SET_SIBLINGS, unimplemented::unimplemented),
    (unimplemented::SPLIT_OUTPUT0, unimplemented::unimplemented),
    (unimplemented::ENTER_SCOPE_SYSCALL_HANDLER, unimplemented::unimplemented),
    (unimplemented::GEN_NONCE_ARG, unimplemented::unimplemented),
    (unimplemented::HAS_ENOUGH_GAS, unimplemented::unimplemented),
    (unimplemented::IS_CASE_RIGHT, unimplemented::unimplemented),
    (unimplemented::SPLIT_INPUTS_3, unimplemented::unimplemented),
    (unimplemented::CACHE_CONTRACT_STORAGE_2, unimplemented::unimplemented),
    (unimplemented::SET_BIT, unimplemented::unimplemented),
    (unimplemented::SET_AP_TO_BLOCK_HASH, unimplemented::unimplemented),
    (unimplemented::VALIDATE_AND_DISCARD_SYSCALL_PTR, unimplemented::unimplemented),
    (unimplemented::GET_OLD_BLOCK_NUMBER_AND_HASH, unimplemented::unimplemented),
    (unimplemented::SET_AP_TO_MAX_FEE, unimplemented::unimplemented),
    (unimplemented::ENTER_SCOPE_NEXT_NODE, unimplemented::unimplemented),
    (unimplemented::ASSERT_CASE_IS_RIGHT, unimplemented::unimplemented),
    (unimplemented::SET_TX_INFO_PTR, unimplemented::unimplemented),
    (unimplemented::SPLIT_INPUTS_12, unimplemented::unimplemented),
    (unimplemented::SET_AP_TO_IS_REVERTED, unimplemented::unimplemented),
    (unimplemented::ENTER_SCOPE_NEXT_NODE_2, unimplemented::unimplemented),
    (unimplemented::WRITE_OLD_BLOCK_TO_STORAGE, unimplemented::unimplemented),
    (unimplemented::DECODE_NODE_2, unimplemented::unimplemented),
    (unimplemented::SET_AP_TO_NOT_DESCEND, unimplemented::unimplemented),
    (unimplemented::PREPARE_PREIMAGE_VALIDATION_BOTTOM, unimplemented::unimplemented),
    (unimplemented::SET_CONTRACT_ADDRESS, unimplemented::unimplemented),
    (unimplemented::SET_AP_TO_NONCE_ARG_SEGMENT, unimplemented::unimplemented),
    (unimplemented::COMPARE_RETURN_VALUE, unimplemented::unimplemented),
    (unimplemented::SPLIT_DESCEND, unimplemented::unimplemented),
    (unimplemented::HEIGHT_IS_ZERO_OR_LEN_NODE_PREIMAGE_IS_TWO, unimplemented::unimplemented),
    (unimplemented::FETCH_STATE_ENTRY_3, unimplemented::unimplemented),
    (unimplemented::ENTER_SCOPE_NEW_TREE, unimplemented::unimplemented),
    (unimplemented::SPLIT_INPUTS_15, unimplemented::unimplemented),
    (unimplemented::SPLIT_INPUTS_9, unimplemented::unimplemented),
    (unimplemented::SET_AP_TO_NONCE_OR_ZERO, unimplemented::unimplemented),
    (unimplemented::PREPARE_PREIMAGE_VALIDATION_NON_DETERMINISTIC_HASHES, unimplemented::unimplemented),
    (unimplemented::GET_COMPILED_CLASS_STRUCT, unimplemented::unimplemented),
    (unimplemented::SPLIT_INPUTS_6, unimplemented::unimplemented),
    (unimplemented::CHECK_RETURN_VALUE_2, unimplemented::unimplemented),
    (unimplemented::FETCH_STATE_ENTRY_4, unimplemented::unimplemented),
    (unimplemented::BUILD_DESCENT_MAP, unimplemented::unimplemented),
    (unimplemented::IS_N_GE_TEN, unimplemented::unimplemented),
    (unimplemented::ENTER_SCOPE_LEFT_CHILD, unimplemented::unimplemented),
    (unimplemented::ENTER_SCOPE_NODE, unimplemented::unimplemented),
    (unimplemented::CHECK_RETURN_VALUE_3, unimplemented::unimplemented),
    (unimplemented::VM_LOAD_PROGRAM, unimplemented::unimplemented),
    (unimplemented::IS_BLOCK_NUMBER_IN_BLOCK_HASH_BUFFER, unimplemented::unimplemented),
    (unimplemented::START_TX_2, unimplemented::unimplemented),
    (unimplemented::GET_SEQUENCER_ADDRESS, unimplemented::unimplemented),
    (unimplemented::FETCH_STATE_ENTRY_5, unimplemented::unimplemented),
    (unimplemented::ENTER_SCOPE_RIGHT_CHILD, unimplemented::unimplemented),
    (unimplemented::WRITE_REQUEST, unimplemented::unimplemented),
    (unimplemented::IS_CASE_NOT_LEFT, unimplemented::unimplemented),
    (unimplemented::SET_CONTRACT_STATE_UPDATES_START, unimplemented::unimplemented),
];
