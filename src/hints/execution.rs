...
pub fn enter_scope_deprecated_syscall_handler<S: Storage + Clone + 'static>(
    _vm: &mut VirtualMachine,
    exec_scopes: &mut ExecutionScopes,
    _ids_data: &HashMap<String, HintReference>,
    _ap_tracking: &ApTracking,
...
pub fn enter_scope_syscall_handler<S: Storage + Clone + 'static>(
    _vm: &mut VirtualMachine,
    exec_scopes: &mut ExecutionScopes,
    _ids_data: &HashMap<String, HintReference>,
    _ap_tracking: &ApTracking,
...
pub fn enter_syscall_scopes<S: Storage + Clone + 'static>(
    _vm: &mut VirtualMachine,
    exec_scopes: &mut ExecutionScopes,
    _ids_data: &HashMap<String, HintReference>,
    _ap_tracking: &ApTracking,
...
pub async fn end_tx_async<S: Storage + Clone + 'static>(exec_scopes: &mut ExecutionScopes) -> Result<(), HintError> {
    let execution_helper = exec_scopes.get::<ExecutionHelperWrapper<S>>(vars::scopes::EXECUTION_HELPER)?;
    execution_helper.end_tx().await;
    Ok(())
}

pub fn end_tx<S: Storage + Clone + 'static>(
    _vm: &mut VirtualMachine,
    exec_scopes: &mut ExecutionScopes,
    _ids_data: &HashMap<String, HintReference>,
    _ap_tracking: &ApTracking,
...
pub async fn enter_call_async<S: Storage + Clone + 'static>(
    vm: &mut VirtualMachine,
    exec_scopes: &mut ExecutionScopes,
    ids_data: &HashMap<String, HintReference>,
    ap_tracking: &ApTracking,
...
pub fn enter_call<S: Storage + Clone + 'static>(
    vm: &mut VirtualMachine,
    exec_scopes: &mut ExecutionScopes,
    ids_data: &HashMap<String, HintReference>,
    ap_tracking: &ApTracking,
...
pub async fn exit_call_async<S: Storage + Clone + 'static>(exec_scopes: &mut ExecutionScopes) -> Result<(), HintError> {
...
pub fn exit_call<S: Storage + Clone + 'static>(
    _vm: &mut VirtualMachine,
    exec_scopes: &mut ExecutionScopes,
    _ids_data: &HashMap<String, HintReference>,
    _ap_tracking: &ApTracking,
...
// above
pub async fn check_execution_async<S: Storage + Clone + 'static>(
    vm: &mut VirtualMachine,
    exec_scopes: &mut ExecutionScopes,
    ids_data: &HashMap<String, HintReference>,
    ap_tracking: &ApTracking,
...
pub fn check_execution<S: Storage + Clone + 'static>(
    vm: &mut VirtualMachine,
    exec_scopes: &mut ExecutionScopes,
    ids_data: &HashMap<String, HintReference>,
    ap_tracking: &ApTracking,
...
async fn cache_contract_storage<S: Storage + Clone + 'static>(
    key: Felt252,
    vm: &mut VirtualMachine,
    exec_scopes: &mut ExecutionScopes,
    ids_data: &HashMap<String, HintReference>,
...
pub async fn write_syscall_result_deprecated_async<S: Storage + Clone + 'static>(
    vm: &mut VirtualMachine,
    exec_scopes: &mut ExecutionScopes,
    ids_data: &HashMap<String, HintReference>,
    ap_tracking: &ApTracking,
...
pub fn write_syscall_result_deprecated<S: Storage + Clone + 'static>(
    vm: &mut VirtualMachine,
    exec_scopes: &mut ExecutionScopes,
    ids_data: &HashMap<String, HintReference>,
    ap_tracking: &ApTracking,
...
pub async fn write_syscall_result_async<S: Storage + Clone + 'static>(
    vm: &mut VirtualMachine,
    exec_scopes: &mut ExecutionScopes,
    ids_data: &HashMap<String, HintReference>,
    ap_tracking: &ApTracking,
...
pub fn write_syscall_result<S: Storage + Clone + 'static>(
    vm: &mut VirtualMachine,
    exec_scopes: &mut ExecutionScopes,
    ids_data: &HashMap<String, HintReference>,
    ap_tracking: &ApTracking,
...
pub async fn write_old_block_to_storage_async<S: Storage + Clone + 'static>(
    vm: &mut VirtualMachine,
    exec_scopes: &mut ExecutionScopes,
    ids_data: &HashMap<String, HintReference>,
    ap_tracking: &ApTracking,
...
pub fn write_old_block_to_storage<S: Storage + Clone + 'static>(
    vm: &mut VirtualMachine,
    exec_scopes: &mut ExecutionScopes,
    ids_data: &HashMap<String, HintReference>,
    ap_tracking: &ApTracking,
...
pub fn cache_contract_storage_request_key<S: Storage + Clone + 'static>(
    vm: &mut VirtualMachine,
    exec_scopes: &mut ExecutionScopes,
    ids_data: &HashMap<String, HintReference>,
    ap_tracking: &ApTracking,
...
pub fn cache_contract_storage_syscall_request_address<S: Storage + Clone + 'static>(
    vm: &mut VirtualMachine,
    exec_scopes: &mut ExecutionScopes,
    ids_data: &HashMap<String, HintReference>,
    ap_tracking: &ApTracking,
...
pub async fn get_old_block_number_and_hash_async<S: Storage + Clone + 'static>(
    vm: &mut VirtualMachine,
    exec_scopes: &mut ExecutionScopes,
    ids_data: &HashMap<String, HintReference>,
    ap_tracking: &ApTracking,
...
pub fn get_old_block_number_and_hash<S: Storage + Clone + 'static>(
    vm: &mut VirtualMachine,
    exec_scopes: &mut ExecutionScopes,
    ids_data: &HashMap<String, HintReference>,
    ap_tracking: &ApTracking,
...
mod tests {
    ...
    async fn test_cache_contract_storage_request_key(
        ...
        cache_contract_storage_request_key::<DictStorage>(&mut vm, &mut exec_scopes, &ids_data, &ap_tracking, &constants)
